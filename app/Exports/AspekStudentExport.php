...
class AspekStudentExport implements FromCollection, WithMapping, WithHeadings, WithEvents
{
    ...
    */
    ...
    {
        $default = [
            'Nis', 'Nama Siswa', 'Nama Aspek', 'Tahun', 'Nilai Semester 1', 'Nilai Semester 2'
        ];
        return $default;
    }
