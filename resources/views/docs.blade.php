...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>DOCS | {{ setting('app_name') }}</title>
			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
					...
					<div class="content pt-0 d-flex flex-column flex-column-fluid" id="kt_content">
						<!--begin::Entry-->
						<!--begin::Hero-->
						<div class="d-flex flex-row-fluid bgi-size-cover bgi-position-top" style="background-image: url('{{ asset('assets/media/bg/bgs-9.jpg') }}')">
							<div class="container">
								<div class="d-flex justify-content-between align-items-center pt-25 pb-35">
									<h3 class="font-weight-bolder text-white mb-0">Dokumentasi cara input</h3>
									<div class="d-flex">
										<a href="#" class="font-size-h4 font-weight-bold">Kembali</a>
									</div>
								</div>
							</div>
						</div>
													...
													<div class="card">
														<div class="card-header" id="faqHeading1">
															<a class="card-title text-dark" data-toggle="collapse" href="#faq1" aria-expanded="true" aria-controls="faq1" role="button">
																...
																<div class="card-label text-dark pl-4">Input Nilai: Cara kerja utama</div>
															</a>
														</div>
														<div id="faq1" class="collapse show" aria-labelledby="faqHeading1" data-parent="#faq">
															<div class="card-body text-dark-50 font-size-lg pl-12">
																<ul>
																	<li>Export template data siswa di menu <span class="font-weight-bold">Master -> data siswa</span></li>
																	<li>Pilih jenis template beserta kelas dan segera download</li>
																	<li>Edit data sesuai dengan template yang anda download tadi <br>
																		<a href="#">cek cara mengisi data excel di documentasi bawah</a>
																	</li>
																	<li>
																		Masuk ke menu input data
																		<ul>
																			<li><a href="{{ route('teacher.nilai.input') }}">Input Nilai</a></li>
																			<li><a href="{{ route('teacher.upd.input') }}">Input UPD</a></li>
																			<li><a href="{{ route('teacher.akhlak.input') }}">Input Akhlak</a></li>
																			<li><a href="{{ route('teacher.ketidakhadiran.input') }}">Input Ketidakhadiran</a></li>
																			<li><a href="{{ route('teacher.prestasi.input') }}">Input Prestasi</a></li>
																			<li><a href="{{ route('teacher.kelulusan.input') }}">Input Kelulusan</a></li>
																			<li><a href="{{ route('teacher.hasil_ujian.input') }}">Input Hasil Ujian</a></li>
																		</ul>
																	</li>
																	<li>Upload file excel yang telah diisi data</li>
																	<li>Klik submit untuk mulai memproses</li>
																</ul>
															</div>
														</div>
													</div>
											...
											<div class="d-flex align-items-center p-6">
												...
												<div class="mr-6">
													<span class="svg-icon svg-icon-4x svg-icon-primary">
														<!--begin::Svg Icon | path:{{ asset('assets/media/svg/icons/Code/Compiling.svg') }}-->
														<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
															<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
									...
									<a href="#" class="card card-custom wave wave-animate bg-grey-100 mb-8 mb-lg-0">
										...
										<div class="card-body">
											<div class="d-flex align-items-center p-6">
												...
												<div class="mr-6">
													<span class="svg-icon svg-icon-4x svg-icon-primary">
														<!--begin::Svg Icon | path:{{ asset('assets/media/svg/icons/Communication/Clipboard-check.svg') }}-->
														<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
															<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																<rect x="0" y="0" width="24" height="24" />
				...
				<div>
					...
					<div class="d-flex align-items-center bg-light-warning rounded p-5 gutter-b">
						<span class="svg-icon svg-icon-warning mr-5">
							<span class="svg-icon svg-icon-lg">
								<!--begin::Svg Icon | path:{{ asset('assets/media/svg/icons/Home/Library.svg') }}-->
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										<rect x="0" y="0" width="24" height="24" />
					...
					<div class="d-flex align-items-center bg-light-danger rounded p-5 gutter-b">
						<span class="svg-icon svg-icon-danger mr-5">
							<span class="svg-icon svg-icon-lg">
								<!--begin::Svg Icon | path:{{ asset('assets/media/svg/icons/Communication/Group-chat.svg') }}-->
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										<rect x="0" y="0" width="24" height="24" />
					...
					<div class="d-flex align-items-center bg-light-info rounded p-5">
						<span class="svg-icon svg-icon-info mr-5">
							<span class="svg-icon svg-icon-lg">
								<!--begin::Svg Icon | path:{{ asset('assets/media/svg/icons/General/Attachment2.svg') }}-->
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										<rect x="0" y="0" width="24" height="24" />
							...
							<div class="text-left flex-grow-1">
								...
								<div class="dropdown dropdown-inline">
									<button type="button" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										<span class="svg-icon svg-icon-lg">
											<!--begin::Svg Icon | path:{{ asset('assets/media/svg/icons/Communication/Add-user.svg') }}-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<polygon points="0 0 24 0 24 24 0 24" />
