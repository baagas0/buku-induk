...
<html lang="en">
	...
	<body id="kt_body" style="background-image: url({{ asset(Auth::guard('master')->user()->background_image) }})" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile">
			<!--begin::Logo-->
			<a href="index.html">
				<img alt="Logo" src="{{ asset('assets/media/logos/logo-l-2.png') }}" class="logo-default max-h-30px" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
							...
							<div class="d-flex align-items-stretch mr-3">
								...
								<div class="header-logo">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ml-4 min-w-75px max-w-100px">
                                            <div class="logo-default app_name text-white font-weight-bolder font-size-lg mb-0">{{ setting('app_name') }}</div>
                                            <div class="logo-default school_name text-white text-hover-white opacity-75 hover-opacity-100">{{ setting('school_name') }}</div>

                                            <div class="logo-sticky app_name text-dark font-weight-bolder font-size-lg mb-0">{{ setting('app_name') }}</div>
                                            <div class="logo-sticky school_name text-dark text-hover-white opacity-75 hover-opacity-100">{{ setting('school_name') }}</div>
                                        </div>
                                    </div>
									{{-- <a href="/">
									</a> --}}
								...
								<div class="dropdown">
									...
									<div class="topbar-item">
										<div class="btn btn-icon btn-hover-transparent-white d-flex align-items-center btn-lg px-md-2 w-md-auto" id="kt_quick_user_toggle">
											...
											<span class="text-white opacity-90 font-weight-bolder font-size-base d-none d-md-inline mr-4">{{ Auth::guard('master')->user()->name }}</span>
											<span class="symbol symbol-35">
												<span class="symbol-label text-white font-size-h5 font-weight-bold bg-white-o-30">{{ Str::upper(Str::limit(Auth::guard('master')->user()->name, 1, '')) }}</span>
											</span>
										</div>
									</div>
									<!--end::Toggle-->
							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex flex-column">
										<!--begin::Title-->
										<h2 class="text-white font-weight-bold my-2 mr-5">@stack('title')</h2>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<div class="d-flex align-items-center font-weight-bold my-2">
											...
											<span class="text-white text-hover-white opacity-75 hover-opacity-100">Dashboard</span>
											<!--end::Item-->
											<!--begin::Item-->
											<span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
											<span class="text-white text-hover-white opacity-75 hover-opacity-100">@stack('title')</span>
											<!--end::Item-->
										</div>
										<!--end::Breadcrumb-->
									</div>
								...
								<div class="d-flex align-items-center">
									<!--begin::Button-->
									@if(isset($button))
									<a href="{{ $button[0]['link'] }}" class="btn btn-transparent-white font-weight-bold py-3 px-6 mr-2">{{ $button[0]['name'] }}</a>
									@endif
									@if(isset($button[1]))
									<a href="{{ $button[1]['link'] }}" class="btn btn-transparent-white font-weight-bold py-3 px-6 mr-2">{{ $button[1]['name'] }}</a>
									@endif
									<!--end::Button-->
								</div>
								<!--end::Toolbar-->
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
                                ...
                                <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
                                    ...
                                    <div class="alert-text">{!! instruction(View::getSection('instruction')) !!}</div>
                                </div>
                                <!--end::Notice-->
                                @endif
		...
		<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
			...
			<div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
				...
				<small class="text-muted font-size-sm ml-2">{{ setting('school_name') }}</small></h3>
			...
			<div class="offcanvas-content pr-5 mr-n5">
						...
						<div class="navi mt-2">
							<a href="mailto:{{ Auth::guard('master')->user()->email }}" class="navi-item">
								<span class="navi-link p-0 pb-2">
									...
									<span class="navi-text text-muted text-hover-primary">{{ Auth::guard('master')->user()->email }}</span>
								</span>
							</a>
				...
				<div class="navi navi-spacer-x-0 p-0">
					<!--begin::Item-->
					<a href="{{ route('master.user.master') }}" class="navi-item">
						<div class="navi-link">
				...
				<div>
					...
					<div class="d-flex align-items-center bg-light-warning rounded p-5 gutter-b">
						...
						<div class="d-flex flex-column flex-grow-1 mr-2">
							<a href="#" class="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1">{{ setting('app_name') }}</a>
							<span class="text-muted font-size-sm">{{ setting('school_name') }}</span>
						</div>
						<span class="font-weight-bolder text-warning py-1 font-size-lg">{{ count(\App\Mapel::select('id')->get()) }} Mapel</span>
					</div>
					<!--end::Item-->
				</div>
				<!--end::Notifications-->
