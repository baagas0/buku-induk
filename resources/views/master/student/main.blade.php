...
var KTDatatableChildRemoteDataDemo = function() {
	...
	var demo = function() {
		...
		function subTableInit(e) {
			...
			}else if(childTable == 'hasil_ujian') {
				toastr.warning('Menampilkan Data Hasil Ujian Siswa '+e.data.name);
				childUrl = '{{ route('master.student.data.hasil.ujian') }}';
				childColumn = [
					{
						field: 'no',
						title: '#',
