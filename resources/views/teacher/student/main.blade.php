...
@push('title', 'Siswa')
@section('instruction', 'student_page')
@section('content')
<!--begin::Card-->
<div class="card card-custom">
	...
	<div class="card-body">
		...
		<!-- Begin Modal Update -->
		@include('teacher.student.modalUpdate')
		<!-- End Modal Update -->
	</div>
</div>
<!--end::Card-->
	...
	var demo = function() {
				...
				},
				{
					...
					template: function(row) {
						return '\
	                        <div class="dropdown dropdown-inline">\
	                            ...
	                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">\
	                                <ul class="navi flex-column navi-hover py-2">\
	                                    ...
	                                    <li class="navi-item">\
	                                        <a href="{{ route('teacher.student.view') }}/'+row.nis+'" class="navi-link">\
	                        ...
	                        <a href="{{ route('teacher.student.detail') }}/personal/'+row.nis+'" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">\
	                            <span class="svg-icon svg-icon-md">\
	                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
	                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
	                                        <rect x="0" y="0" width="24" height="24"/>\
		...
		$('#updateUPD').on('shown.bs.modal', function (e) {
			...
			if (type == 'create') {
				...
				$.ajax({
					type: "POST",
					url: "{{ route('teacher.student.data.upd') }}/"+id,
		...
		$('#saveUpdateUpd').on('click', function() {
			...
			if (type == 'create') {
				$.ajax({
					type: "POST",
					url: "{{ route('teacher.student.update.upd') }}/"+type,
					data: {
						upd_id: $('#upd_name').val(),
				...
				$.ajax({
					type: "POST",
					url: "{{ route('teacher.student.update.upd') }}/"+type+'/'+id,
					data: {
						n_smt_1: $('#upd_n_smt_1').val(),
						n_smt_2: $('#upd_n_smt_2').val(),
					},
		...
		$('#updateAspek').on('shown.bs.modal', function (e) {
			...
			if (type == 'create') {
				...
				$.ajax({
					type: "POST",
					url: "{{ route('teacher.student.data.akhlak') }}/"+id,
					success: function(data){
						toastr.success('Berhasil mengambil data UPD');
						console.log(data);
		...
		$('#saveUpdateAspek').on('click', function() {
			...
			if (type == 'create') {
				$.ajax({
					type: "POST",
					url: "{{ route('teacher.student.update.akhlak') }}/"+type,
					data: {
				...
				$.ajax({
					type: "POST",
					url: "{{ route('teacher.student.update.akhlak') }}/"+type+'/'+id,
					data: {
						n_smt_1: n_smt_1,
						n_smt_2: n_smt_2,
					},
		...
		$('#updateKetidakhadiran').on('shown.bs.modal', function (e) {
			...
			if (type == 'create') {
				...
				$.ajax({
					type: "POST",
					url: "{{ route('teacher.student.data.ketidakhadiran') }}/"+id,
					success: function(data){
						toastr.success('Berhasil mengambil data UPD');
						console.log(data);
		...
		$('#saveUpdateKetidakhadiran').on('click', function() {
			...
			if (type == 'create') {
				$.ajax({
					type: "POST",
					url: "{{ route('teacher.student.update.ketidakhadiran') }}/"+type,
					data: {
				...
				$.ajax({
					type: "POST",
					url: "{{ route('teacher.student.update.ketidakhadiran') }}/"+id,
					data: {
						n_smt_1: n_smt_1,
						n_smt_2: n_smt_2,
					},
		...
		$('#updatePrestasi').on('shown.bs.modal', function (e) {
			...
			if (type == 'create') {
				...
				$.ajax({
					type: "POST",
					url: "{{ route('teacher.student.data.prestasi') }}/"+id,
					success: function(data){
						toastr.success('Berhasil mengambil data UPD');
						console.log(data);
		...
		$('#saveUpdatePrestasi').on('click', function() {
			...
			if (type == 'create') {
				$.ajax({
					type: "POST",
					url: "{{ route('teacher.student.update.prestasi') }}/"+type,
					data: {
						student_id: student_id,
				...
				$.ajax({
					type: "POST",
					url: "{{ route('teacher.student.update.prestasi') }}/"+type+'/'+id,
					data: {
						kegiatan_id: kegiatan_id,
						nomor_sertifikat: nomor_sertifikat,
					},
		...
		$('#updateKelulusan').on('shown.bs.modal', function (e) {
			...
			if (type == 'create') {
				...
				$.ajax({
					type: "POST",
					url: "{{ route('teacher.student.data.kelulusan') }}/"+id,
					success: function(data){
						toastr.success('Berhasil mengambil data UPD');
						console.log(data);
		...
		$('#saveUpdateKelulusan').on('click', function() {
			...
			if (type == 'create') {
				$.ajax({
					type: "POST",
					url: "{{ route('teacher.student.update.kelulusan') }}/"+type,
					data: {
						student_id: student_id,
				...
				$.ajax({
					type: "POST",
					url: "{{ route('teacher.student.update.kelulusan') }}/"+type+'/'+id,
					data: {
						ijazah: $('#kelulusan_ijazah').val(),
						skhun: $('#kelulusan_skhun').val(),
						shuambn: $('#kelulusan_shuambn').val(),
		...
		function subTableInit(e) {
			...
			if (childTable == 'upd') {
				...
				childUrl = '{{ route('teacher.student.data.upd') }}';
				childColumn = [
					{
						field: 'id',
						title: '#',
				...
				childUrl = '{{ route('teacher.student.data.akhlak') }}';
				childColumn = [
					{
						field: 'id',
						title: '#',
				...
				childUrl = '{{ route('teacher.student.data.ketidakhadiran') }}';
				childColumn = [
					{
						field: 'id',
						title: '#',
				...
				childUrl = '{{ route('teacher.student.data.prestasi') }}';
				childColumn = [
					{
						field: 'id',
						title: '#',
				...
				childUrl = '{{ route('teacher.student.data.kelulusan') }}';
				childColumn = [
					{
						field: 'id',
						title: '#',
		...
		function deleteData(table, fieldId) {
			$.ajax({
				type: "POST",
				url: "{{ route('teacher.student.delete.data') }}/"+table+"/"+fieldId,
				success: function(data){
